...
public class InformixMyBatisConfig {
	...
	public SqlSessionFactory sqlSessionFactoryBean(
			@Qualifier(DatasourceConfiguration.PRIMARY_DATASOURCE) DataSource dataSource) throws Exception {
	...
	public DataSourceTransactionManager informixTransactionManager(
			@Qualifier(DatasourceConfiguration.PRIMARY_DATASOURCE) DataSource dataSource) {
