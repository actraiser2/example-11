...
public class ApiDelegateTestUtils {
  ...
  protected static List<EmployeeDomain> getListEmployeeDomain() {
  ...
  protected static List<EmployeeResource> getListEmployeeResource() {
  ...
  public static List<IndicadoresCentroDomain> getIndicadoresList() {
  ...
  public static List<IndicadorResource> getIndicadoresListResource() {
